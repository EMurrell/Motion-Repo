...
export default function TwitterShare({ className }: TwitterShareProps) {
  return (
    <a
      className={` ${className} h-max min-w-max flex items-center gap-3 bg-white rounded-xl px-2 py-1  text-[0.8125rem] leading-6 text-gray-900 transition hover:bg-gray-100/80`}
